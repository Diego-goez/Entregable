  ...
  <div class="modal-dialog">
    <div class="modal-content">
          ...
          <div class="box-body">
            <div class="row">
                ...
                <!-- texto box -->
                    <div class="input-group">
                        <span class="input-group-addon">fecha de nacimiento</span>
                        <input type="date" class="form-control" id="txtFechanaciM" name="txtFechanaciM">
      ...
      <div class="modal-footer">
        <div>
          <button class="btn btn-app float-left" onclick="validateModifyAprendiz(event)">
              <i class="fa fa-save"></i> Guardar
          </button>
          <?php
